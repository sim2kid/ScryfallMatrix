...
[![AI-Generated | Human-Reviewed](https://img.shields.io/badge/AI--Generated-Human--Reviewed-blue)](AI_POLICY.md)

A Matrix bot that provides an API and cache for Scryfall card lookups. Not associated or endorsed by Scryfall.

> **AI Disclosure:** This project is primarily developed using AI Agents with human oversight. See [AI_POLICY.md](AI_POLICY.md) for more details.
